...
const MentionInput: FC<MentionInputProps> = (
  ...
  const onChangeInput = (changedText: string) => {
    keyword(getMentionPartSuggestionKeywords(
      parts,
      plainText,
      selection,
      partTypes,
 ...
 style={{position: 'absolute', paddingTop: Platform.OS === 'web' ? 0 : 5,...textInputProps.style, ...overlayContainerStyle}} pointerEvents={'none'}>
